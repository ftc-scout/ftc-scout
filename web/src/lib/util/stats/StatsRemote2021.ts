...
export type FullStats_TeamEventStats2021Remote_Fragment = {
...
export let RP_STAT: Stat<FullStats_TeamEventStats2021Remote_Fragment> = {
    color: StatColor.RED,
...
export let RANK_STAT: Stat<FullStats_TeamEventStats2021Remote_Fragment> = {
...
export let TBP_STAT: Stat<FullStats_TeamEventStats2021Remote_Fragment> = {
...
export let TBP2_STAT: Stat<FullStats_TeamEventStats2021Remote_Fragment> = {
...
export let PLAYED_STAT: Stat<FullStats_TeamEventStats2021Remote_Fragment> = {
...
export let AVG_STAT: Stat<FullStats_TeamEventStats2021Remote_Fragment> = {

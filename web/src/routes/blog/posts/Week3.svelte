...
<PostTemplate>
    <svelte:fragment slot="title">Making Up Statistics</svelte:fragment>
    <svelte:fragment slot="author">Jonah Reinis</svelte:fragment>
    <svelte:fragment slot="date">October 30, 2022</svelte:fragment>

    <p>
        <em>All statistics in this article refer to the 2021 Freight Frenzy Season.</em>
    </p>

    <p>A wise man once said “OPR is the den of foolish robotics teams." I say we build a city of fools.</p>
    ...
    <p>
        For all its flaws, OPR still does a decent job at approximating a team’s performance. However, in the spirit of
        America’s Pastime, I’d like to introduce some pitches for new statistics we could use in FTC, to show a
        different perspective. Oh boy do I love making up numbers.
    </p>

    <p>
        Average Domination (AD): Average Domination is the statistic found by dividing your team’s average by the
        event’s average, simple enough. The team with the highest AD (not including remote events, refer to the previous
        report) is <a href="https://ftcscout.org/teams/16439">Team 16439, AlphaGo</a>, at the
        <a href="https://ftcscout.org/events/2021/USCHSNOQ1/matches">VA Norfolk Qualifier 1</a>. At this event, AlphaGo
        had an AD of ~2.8 meaning that they did about 3 times better than the average team at that event.
    </p>

    <p>
        League Domination (LD): League Domination is the statistic found by dividing your team’s OPR by your team’s
        average at any given event. This statistic both shows how lucky you are in terms of teammates, but also how you
        compare to the rest of your league (again not including remote events). For example an LD of 60% means that you
        did on average 60% of the work in every alliance you were in. Interestingly enough, at <a
            href="https://ftcscout.org/events/2021/USOKNEM1/matches">OK Newcastle</a
        >,
    ...
    <p>
        These are just some statistics I thought were interesting. Really you could apply this idea of “domination” to

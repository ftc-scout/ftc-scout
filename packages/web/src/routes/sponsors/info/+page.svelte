...
<Head title="Sponsor Info | FTCScout" description="Become a sponsor of FTCScout" />
        ...
        <div class="rest">
            ...
            <div class="image-wrap">
                <img
                    ...
                    alt="A screenshot of FTCScout's Teams Records page, with a green example logo in the sidebar"
                />
            </div>
            <h2>Our expenses:</h2>
